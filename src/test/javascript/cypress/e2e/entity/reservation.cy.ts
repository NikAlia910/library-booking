...
describe('Reservation e2e test', () => {
  ...
  // const reservationSample = {"reservationDate":"2025-05-29T12:03:26.474Z","startTime":"2025-05-29T22:59:44.518Z","endTime":"2025-05-29T17:28:16.976Z","reservationId":"raw hm"};
  ...
  describe('new Reservation page', () => {
    ...
    it.skip('should create an instance of Reservation', () => {
      cy.get(`[data-cy="reservationDate"]`).type('2025-05-29T16:15');
      cy.get(`[data-cy="reservationDate"]`).blur();
      cy.get(`[data-cy="reservationDate"]`).should('have.value', '2025-05-29T16:15');

      cy.get(`[data-cy="startTime"]`).type('2025-05-29T06:01');
      cy.get(`[data-cy="startTime"]`).blur();
      cy.get(`[data-cy="startTime"]`).should('have.value', '2025-05-29T06:01');

      cy.get(`[data-cy="endTime"]`).type('2025-05-29T02:53');
      cy.get(`[data-cy="endTime"]`).blur();
      cy.get(`[data-cy="endTime"]`).should('have.value', '2025-05-29T02:53');
