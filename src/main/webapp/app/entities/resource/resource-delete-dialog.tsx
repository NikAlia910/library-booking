...
import { deleteEntity, getEntity } from './resource.reducer';
...
export const ResourceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="libraryBookingApp.resource.delete.question">Are you sure you want to delete Resource {resourceEntity.id}?</ModalBody>
      <ModalFooter>
