            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('reservationDate')}>
                  Reservation Date <FontAwesomeIcon icon={getSortIconByFieldName('reservationDate')} />
                </th>
                ...
                <th className="hand" onClick={sort('reservationId')}>
                  Reservation Id <FontAwesomeIcon icon={getSortIconByFieldName('reservationId')} />
                </th>
                <th>
            ...
            <tbody>
              {reservationList.map((reservation, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{reservation.resource ? <Link to={`/resource/${reservation.resource.id}`}>{reservation.resource.id}</Link> : ''}</td>
